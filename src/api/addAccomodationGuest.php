<?php
  ...
  if(!file_exists('../../db.json')) {
    system('echo \'{"accomodationGuests":[], "registrants":[]}\' > ../../db.json');
  }
  ...
  if (strcmp ($res, "VERIFIED") !== false) {
    ...
    $accomodationName = $_POST['item_name1'];
